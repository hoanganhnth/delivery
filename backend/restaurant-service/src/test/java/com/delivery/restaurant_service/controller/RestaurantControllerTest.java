...
//        response.setDescription("Best pizza in town");
        ...
        mockMvc.perform(post("/api/restaurants")
                ...
                .andExpect(jsonPath("$.data.description").value("Best pizza in town"));

        verify(restaurantService).createRestaurant(any(CreateRestaurantRequest.class), eq(1L), eq("RESTAURANT_OWNER"));
    }
